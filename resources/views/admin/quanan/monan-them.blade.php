...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            <div class="card-body">
                <form action="" id="formthemnhanhieu" method="post" data-url="{{route('admin.mon-an.store',['idquan'=>$quan_an_id])}}">
                    @csrf

                    <p class="text-center title">THÊM MÓN ĂN</p>
                    <div class="position-relative row form-group">
                        <label for="ten-mon" class="col-md-3 text-md-right col-form-label">{{trans('public.name')}}</label>
                        <div class="col-md-9 col-xl-8">
                            <input name="ten-mon" id="ten-mon" placeholder="Tên món ăn" type="text" class="form-control" value="">
                        </div>
                    </div>
