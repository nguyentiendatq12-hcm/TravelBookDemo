        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    <a href="{{ route('admin.quan-an.create') }}" class="btn-shadow btn-hover-shine mr-3 btn btn-primary">
                        ...
                        <div class="card-body">
                            <form action="" method="get" class="mb-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="" class="input-lable">{{ trans('public.location') }}</label>
                                            <select name="location" id="location" class="form-control">
                                                <option value="">{{ trans('public.location') }}</option>
                                                @foreach ($ls_dia_diem as $key => $value)
                                                    <option value="{{$value->id }}"
                                                        {{request()->get('location') == $value->id ? 'selected' : '' }}>{{ $value->ten_dia_diem }}
                                                    </option>
                                                @endforeach
                            ...
                            <tbody>
                                @foreach ($ls_quan_an as $key => $value)
                                    <tr>
                                        ...
                                        <td class="text-center">{{ $value->dia_chi }}, {{ $value->xa }}, {{ $value->huyen }}, {{ $value->tinh }}</td>
                                        <td class="td-radio">
