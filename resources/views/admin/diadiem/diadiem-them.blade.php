        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('admin.dia-diem.store') }}">
                            @csrf
                                        ...
                                        <li class="float-left d-inline-block mr-2 mb-2" style="width: 32%;">
                                            ...
                                            <div style="width: 100%; max-height: 100%; overflow: hidden;"
                                                ...
                                                <img style="width: 100%; cursor: pointer;" class="thumbnail"
                                                    ...
                                                    src="{{ URL(old('hinh-dia-diem') ?? 'assets/img/add-image-icon.jpg') }}" alt="Add Image">

                                                <input name="hinh-dia-diem" type="file" onchange="changeImg(this);"
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="ten_dia_diem" id="ten" placeholder="Tên địa danh" type="text"
                                        class="form-control" value="{{ old('ten_dia_diem') }}">
                                    <div class="text-center">
                                        @error('ten_dia_diem')
                                            <span style="color:red"> {{ $message }}</span>
                                        @enderror
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input name="mua-du-lich" id="mua-du-lich"
                                        placeholder="{{ trans('public.tourist_season') }}" type="text"
                                        class="form-control" value="{{ old('mua-du-lich') }}">
                                    <div class="text-center">
                                        @error('mua-du-lich')
                                            <span style="color:red"> {{ $message }}</span>
                                        @enderror
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <textarea class="form-control" name="noidung" id="noidung" placeholder="{{ trans('public.content') }}"
