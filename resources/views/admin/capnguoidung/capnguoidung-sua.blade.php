        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{route('admin.vai-tro-nguoi-dung.update',['id'=>$role    ->id])}}">
                            @csrf
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="name" id="name" placeholder="tên" type="text"
                                        class="form-control" value="{{ old('name') ?? $role->ten }}">
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="chuc-danh" id="chuc-danh" placeholder="vd: nhân viên kế toán" type="text"
                                        class="form-control" value="{{ old('chuc-danh') ?? $role->chuc_danh  }}">
                                    <div class="text-center">
                                        @error('chuc-danh')
                                            <span style="color:red"> {{ $message }}</span>
                                        @enderror
