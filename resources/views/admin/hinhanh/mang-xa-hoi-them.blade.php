        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <form method="post" enctype="multipart/form-data" action="{{ route('admin.post-mang-xa-hoi-them') }}">
                            @csrf
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input required name="link" id="link" placeholder="https://www.google.com" type="url"
                             ...
                             <div class="position-relative row form-group">
                                ...
                                <div class="col-md-9 col-xl-8">
                                    <input class="form-check-input them-slideshow-check" type="checkbox" value="" id="" name="check-hien">
