...
@section('content')
    ...
    <section class="ftco-section ftco-degree-bg">
        <input disabled type="hidden" value="{{ $bai_viet->id }}" id="bai_viet_id">
        <div class="container">
            <div class="row">
                <div class="col-md-8 ftco-animate">
                    ...
                    <div class="pt-5 mt-5">
                        <div class="comment-form-wrap pt-5">
                            ...
                            <form action="" class="p-5 bg-light" data-url="{{ route('web.bai-viet.binh-luan-bai-viet', ['id'=>$bai_viet->id]) }}" id="binh-luan-bai-viet">
                                @csrf
...
@section('js')
    <script>
        ...
        function rep_binh_luan_bai_viet(id_bai_viet, id_binh_luan, page) {
            var url = "{{ route('web.bai-viet.binh-luan-bai-viet', '') }}" + '/' + id_bai_viet;
        ...
        function load_binh_luan(page) {
            var url = "{{ route('web.bai-viet.load-binh-luan-bai-viet') }}"
            var id_bai_viet = $('#bai_viet_id').val();
